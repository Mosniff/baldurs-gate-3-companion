...
export const commonAbilities: { [key: string]: Ability } = {
  ...
  "extra attack": {
    name: "extra attack",
    url: "https://bg3.wiki/wiki/Extra_Attack",
  },
};
...
export const barbarianAbilities: { [key: string]: Ability } = {
  "unarmored defence": {
    ...
    url: "https://bg3.wiki/wiki/Unarmoured_Defence_(Barbarian)",
  },
  rage: {
    name: "rage",
    url: "https://bg3.wiki/wiki/Rage",
  },
  "danger sense": {
    name: "danger sense",
    url: "https://bg3.wiki/wiki/Danger_Sense",
  },
  "reckless attack": {
    name: "reckless attack",
    url: "https://bg3.wiki/wiki/Reckless_Attack",
  },
  ...
  "fast movement": {
    name: "fast movement",
    url: "https://bg3.wiki/wiki/Fast_Movement",
  },
  "feral instinct": {
    name: "feral instinct",
    url: "https://bg3.wiki/wiki/Feral_Instinct",
  },
  "brutal critical": {
    name: "brutal critical",
    url: "https://bg3.wiki/wiki/Brutal_Critical",
  },
  "relentless rage": {
    name: "relentless rage",
    url: "https://bg3.wiki/wiki/Relentless_Rage",
  },
  frenzy: {
    name: "frenzy",
    url: "https://bg3.wiki/wiki/Frenzy",
  },
  "frenzied strike": {
    name: "frenzied strike",
    url: "https://bg3.wiki/wiki/Frenzied_Strike",
  },
  "enraged throw": {
    name: "enraged throw",
    url: "https://bg3.wiki/wiki/Enraged_Throw",
  },
  "mindless rage": {
    name: "mindless rage",
    url: "https://bg3.wiki/wiki/Mindless_Rage",
  },
  "intimidating presence": {
    name: "intimidating presence",
    url: "https://bg3.wiki/wiki/Intimidating_Presence",
  },
  "speak with animals": {
  ...
  "bestial heart": {
    name: "bestial heart",
    url: "https://bg3.wiki/wiki/Wildheart",
  },
  "animal aspect": {
    name: "animal aspect",
    url: "https://bg3.wiki/wiki/Wildheart",
  ...
  "land's stride: difficult terrain": {
    ...
    url: "https://bg3.wiki/wiki/Land%27s_Stride",
  },
  "rage: wild magic": {
    name: "rage: wild magic",
    url: "https://bg3.wiki/wiki/Rage:_Wild_Magic",
  },
  "magic awareness": {
    name: "magic awareness",
    url: "https://bg3.wiki/wiki/Wild_Magic_Barbarian",
  },
  ...
  "unstable backlash": {
    ...
    url: "https://bg3.wiki/wiki/Unstable_Backlash",
  },
};
